...
const styles = StyleSheet.create({
  ...
  tag: { alignSelf: "flex-start", overflow: "hidden", borderRadius: 12, backgroundColor: "#eee6ff", paddingHorizontal: 10, paddingVertical: 5, fontSize: 11, fontWeight: "700", color: "#7651bc" },
