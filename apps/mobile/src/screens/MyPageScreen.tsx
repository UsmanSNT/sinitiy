...
const styles = StyleSheet.create({
  ...
  guestName: { color: colors.white, fontSize: 20, fontWeight: "700" }, guestCopy: { color: "rgba(255,255,255,0.7)", fontSize: 14, marginTop: 4 },
  ...
  loginButtonText: { color: colors.white, fontSize: 16, fontWeight: "700" }, signupButton: { borderWidth: 1, borderColor: colors.border, borderRadius: 999, paddingVertical: 13, alignItems: "center" },
