...
const styles = StyleSheet.create({
  ...
  tag: { alignSelf: "flex-start", overflow: "hidden", borderRadius: 12, backgroundColor: "#dceeff", paddingHorizontal: 10, paddingVertical: 5, fontSize: 13, fontWeight: "700", color: "#2774ba" },
  ...
  infoLabel: { width: 84, fontSize: 15, fontWeight: "800", color: "#2b6597" },
