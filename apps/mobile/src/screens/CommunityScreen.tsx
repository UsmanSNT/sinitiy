...
const styles = StyleSheet.create({
  ...
  postTitle: { fontSize: 17, fontWeight: "800", color: colors.navy },
  postMeta: { marginTop: 4, fontSize: 13, color: "#8995a7" },
  postBody: { marginTop: 8, fontSize: 14, lineHeight: 20, color: "#536176" },
