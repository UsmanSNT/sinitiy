...
const styles = StyleSheet.create({
  ...
  category: { fontSize: 12, color: colors.accent, fontWeight: "700", marginTop: 16 },
  title: { fontSize: 20, fontWeight: "700", color: colors.navy, marginTop: 6 },
  author: { fontSize: 12, color: colors.gray, marginTop: 4 },
  ...
  reportSent: { marginTop: 8, fontSize: 12, color: colors.gray },
