// Daehan Minguk (Korea) sido/sigungu administrative division list.
// 2026-yil 7-iyuldagi holatga mos (Incheon qayta tashkil etildi: 중구/동구 o'rniga
// 제물포구/영종구/검단구, 서구 endi 서해구; Gwangju + Jeonnam "전남광주통합특별시"ga
// birlashtirildi). Ro'yxat kamdan-kam o'zgaradi, shuning uchun statik saqlanadi.
...
export const KOREA_REGIONS: KoreaRegion[] = [
  ...
  { sido: "대전광역시", sigungu: ["중구", "서구", "동구", "유성구", "대덕구"] },
